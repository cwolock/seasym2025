...
\nabla f(h(\psi_n))]^{1/2} \bigr\} \ , \ \mbox{where}
$$
\vspace{-0.2in}
...
* $h$ (`contrast$h`) is a contrast of counterfactual means, 
* $\nabla f(h(\psi_n))$(`contrast$fh_grad`) defines the gradient of the transformed contrast at the estimated counterfactual means, and
* $\Sigma_n$ is the doubly-robust covariance matrix estimate (automatically obtained from
`drtmle`). 
...
<!-- The outcome regression is $E(\Delta_Y Y \midd \Delta_A A = a, \Delta_A = 1, \Delta_Y = 1, W)$.  -->


<!-- The propensity score is \begin{align*} -->
<!-- &\mbox{pr}(\Delta_A = 1, \Delta_A A = a, \Delta_Y = 1 \midd W) \\ -->
<!-- &\hspace{0.2in} = \mbox{pr}_0(\Delta_A = 1 \midd W) \times \mbox{pr}_0(\Delta_A A = a \midd \Delta_A = 1, W) \times \mbox{pr}_0(\Delta_Y = 1 \midd \Delta_A = 1, \Delta_A A = a, W) \ . -->
<!-- \end{align*} -->
...
<!--   \sum\limits_{a \in \mathcal{A}} \widehat{\mbox{pr}}(A = a \midd W = w) = 1 \ \mbox{for all $w$} \ . -->
<!-- $$ -->
...
<!-- 	\widehat{\mbox{pr}}(A = 0 \midd W) \ , \ \mbox{and} \ \widehat{\mbox{pr}}(A = 1 \midd A > 0, W) \ , -->
<!-- \end{align*} -->
<!-- and we set \begin{align*} -->
<!-- \widehat{\mbox{pr}}(A = 1 \midd W) &= \widehat{\mbox{pr}}(A = 1 \midd A > 0, W) [1 - \widehat{\mbox{pr}}(A = 0 \midd W)] \\  -->
<!-- \widehat{\mbox{pr}}(A = 2 \midd W) &= 1 - \widehat{\mbox{pr}}(A = 0 \midd W) - \widehat{\mbox{pr}}(A = 1 \midd W) \ .  -->
<!-- \end{align*} -->
